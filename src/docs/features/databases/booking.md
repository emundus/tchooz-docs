...
| **conference_engine**          | VARCHAR(50)  | null |  |teams, zoom, other |
| **generate_link_by**           | INTEGER      | null |  |Par réservation, par plage de réservation |
| **link**                       | VARCHAR(255) | null |  | |
| **manager**                    | INTEGER      | null |  | |
| **available_for**              | INTEGER      | not null |  |campaigns, programs |
| **slot_duration**              | INTEGER      | null |  | |
| **slot_break_every**           | INTEGER      | null |  | |
| **slot_break_time**            | INTEGER      | null |  | |
| **slots_availables_to_show**   | INTEGER      | null |  | |
| **slot_can_book_until_days**   | INTEGER      | null |  | |
| **slot_can_book_until_date**   | DATETIME     | null |  | |
| **slot_can_cancel**            | TINYINT      | null |  | |
| **slot_can_cancel_until_days** | INTEGER      | null |  | |
| **slot_can_cancel_until_date** | DATETIME     | null |  | | 
| **created_by**                 | INTEGER      | not null |  | | 
| **updated**                    | DATETIME     | null |  | | 
| **updated_by**                 | INTEGER      | null |  | | 


##### data_events_location
...
| **room** | INTEGER | null | jos_emundus_setup_ranges_room_id_fk | |
| **slot_capacity** | INTEGER | not null |  | |
| **more_infos** | TEXT(65535) | null |  | | 
...
- **jos_emundus_setup_events to data_events_location**: many_to_one
- **data_location_rooms to data_events_location**: many_to_one
...
```mermaid
erDiagram
	jos_emundus_setup_events ||--o{ data_events_location : references
	data_location_rooms ||--o{ data_events_location : references
